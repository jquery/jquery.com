...
1. Upgrade the version of jQuery on the page to the latest 1.x or 2.x version (currently 1.12.4 or 2.2.4).
...
6. Upgrade the version of jQuery on the page to the latest 3.0 version (currently 3.2.1) and add the uncompressed [jQuery Migrate 3.x plugin](https://github.com/jquery/jquery-migrate/#README) to the page.
